...
public class EachCountryDataActivity extends AppCompatActivity {
    ...
    LinearLayout indiaDataLayout,feelingSickLayout,gooHabitslayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        indiaDataLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent( EachCountryDataActivity.this,MainActivity.class));
            }
        });
        ...
        feelingSickLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent( EachCountryDataActivity.this,contact.class));

                //  Toast.makeText(EachCountryDataActivity.this, "Feeling Sick", Toast.LENGTH_SHORT).show();
            }
        });
        gooHabitslayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent( EachCountryDataActivity.this,symtoms.class));

                // Toast.makeText(EachCountryDataActivity.this, "Good habits", Toast.LENGTH_SHORT).show();
            }
        });
        ///////////////////////////////////////////////
    }
