...
public class StateWiseDataActivity extends AppCompatActivity {
    ...
    private String str_state,    str_confirmed, str_confirmed_new, str_active,
            str_active_new, str_recovered, str_recovered_new,
            str_death, str_death_new,   str_lastupdatedate;

    private MainActivity activity = new MainActivity();


    LinearLayout worldDataLayout,gooHabitslayout,feelingSickLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        worldDataLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(StateWiseDataActivity.this, WorldDataActivity.class));
            }
        });
        ...
        feelingSickLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(StateWiseDataActivity.this, contact.class));
                //Toast.makeText(StateWiseDataActivity.this, "Feeling Sick", Toast.LENGTH_SHORT).show();
            }
        });
        gooHabitslayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(StateWiseDataActivity.this, symtoms.class));
                //Toast.makeText(StateWiseDataActivity.this, "Good habits", Toast.LENGTH_SHORT).show();
            }
        });
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            // fetching the date Statevise and Making their object By State Class
                            // and storing the state objects in Our ArrayList....
