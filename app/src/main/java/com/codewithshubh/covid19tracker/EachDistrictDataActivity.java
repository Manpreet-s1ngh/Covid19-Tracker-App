    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        worldDataLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(EachDistrictDataActivity.this, WorldDataActivity.class));
            }
        });
        ...
        feelingSickLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EachDistrictDataActivity.this, contact.class));

                //Toast.makeText(EachDistrictDataActivity.this, "Feeling Sick", Toast.LENGTH_SHORT).show();
            }
        });
        gooHabitslayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EachDistrictDataActivity.this, symtoms.class));
                // Toast.makeText(EachDistrictDataActivity.this, "Good habits", Toast.LENGTH_SHORT).show();
            }
        });
