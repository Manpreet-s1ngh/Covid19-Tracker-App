...
public class CountryWiseDataActivity extends AppCompatActivity {
    ...
    LinearLayout indiaDataLayout,gooHabitslayout,feelingSickLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        indiaDataLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent( CountryWiseDataActivity.this,MainActivity.class));
            }
        });
        ...
        feelingSickLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent( CountryWiseDataActivity.this,contact.class));

                //Toast.makeText(CountryWiseDataActivity.this, "Feeling Sick", Toast.LENGTH_SHORT).show();
            }
        });
        gooHabitslayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent( CountryWiseDataActivity.this,symtoms.class));

                //Toast.makeText(CountryWiseDataActivity.this, "Good habits", Toast.LENGTH_SHORT).show();
            }
        });
        /////////////////////////////////////////////////////
