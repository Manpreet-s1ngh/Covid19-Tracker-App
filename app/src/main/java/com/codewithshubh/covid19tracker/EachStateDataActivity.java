...
public class EachStateDataActivity extends AppCompatActivity {
    ...
    LinearLayout worldDataLayout,feelingSickLayout,gooHabitslayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        worldDataLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(EachStateDataActivity.this, WorldDataActivity.class));
            }
        });
        ...
        feelingSickLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EachStateDataActivity.this, contact.class));
               // Toast.makeText(EachStateDataActivity.this, "Feeling Sick", Toast.LENGTH_SHORT).show();
            }
        });
        gooHabitslayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EachStateDataActivity.this, symtoms.class));

                //Toast.makeText(EachStateDataActivity.this, "Good habits", Toast.LENGTH_SHORT).show();
            }
        });
