...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tv_confirmed, tv_confirmed_new, tv_active, tv_active_new, tv_recovered, tv_recovered_new,
            tv_death, tv_death_new, tv_tests, tv_tests_new, tv_date, tv_time;
    ...
    LinearLayout worldDataLayout , gooHabitslayout, feelingSickLayout,lin_state_data,goToStataActivitySearch;
...
*/
        ...
        goToStataActivitySearch=findViewById(R.id.goToSearchActivity);
        goToStataActivitySearch.setOnClickListener(new View.OnClickListener() {
            @SuppressLint("ResourceAsColor")
            @Override
            public void onClick(View view) {
                //findViewById(R.id.indiaDataLayout).setBackgroundColor(R.color.bg);
                startActivity(new Intent(MainActivity.this, StateWiseDataActivity.class));
            }
        });

        worldDataLayout=findViewById(R.id.worldDataLayout);
        gooHabitslayout=findViewById(R.id.GoodHabits);
        ...
        gooHabitslayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        //As the data of the json are in a nested array,
                        // so we need to define the array from which we want to fetch the data.
    ...
    // To Format Date according to our need
    ...
    // for initializing the FindViewById
    private void Init() {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.menu_about) {
            ...
            startActivity(new Intent(MainActivity.this, BottomNavigation_Activity.class));
        }
...
*/
    ...
    public void onBackPressed() {
        ...
        // if the user will note press back Button for 2 seconds---press the back button for two times
