...
public class WorldDataActivity extends AppCompatActivity {
    ...
    String str_confirmed, str_confirmed_new, str_active,
    ...
    private LinearLayout indiaDataLayout,worldDataLayout,gooHabitslayout,feelingSickLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //////////////////////
        indiaDataLayout=findViewById(R.id.indiaDataLayout);
        ...
        indiaDataLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent( WorldDataActivity.this,MainActivity.class));
            }
        });
        ...
        feelingSickLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent( WorldDataActivity.this,contact.class));
                //Toast.makeText(WorldDataActivity.this, "Feeling Sick", Toast.LENGTH_SHORT).show();
            }
        });
        gooHabitslayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent( WorldDataActivity.this,symtoms.class));

                // Toast.makeText(WorldDataActivity.this, "Good habits", Toast.LENGTH_SHORT).show();
            }
        });
