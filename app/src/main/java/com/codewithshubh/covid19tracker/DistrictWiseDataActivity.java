    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        worldDataLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DistrictWiseDataActivity.this, WorldDataActivity.class));
            }
        });
        ...
        feelingSickLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DistrictWiseDataActivity.this, contact.class));

                //Toast.makeText(DistrictWiseDataActivity.this, "Feeling Sick", Toast.LENGTH_SHORT).show();
            }
        });
        gooHabitslayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DistrictWiseDataActivity.this, symtoms.class));

                //Toast.makeText(DistrictWiseDataActivity.this, "Good habits", Toast.LENGTH_SHORT).show();
            }
        });
